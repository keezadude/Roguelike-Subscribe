@echo off
echo ================================================
echo  Roguelike & Subscribe - Collision Test
echo  Testing vehicle-ragdoll collision detection
echo ================================================
echo.

REM Temporarily rename main.lua and use gameplay-test.lua
if exist main.lua.backup del main.lua.backup
if exist main.lua ren main.lua main.lua.backup
copy gameplay-test.lua main.lua >nul
